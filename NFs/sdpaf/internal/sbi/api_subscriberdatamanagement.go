...
func (s *Server) getOneLayerRoutes() []Route {
	return []Route{
		...
		// },
		{
			Method:  http.MethodGet,
			Pattern: "/:supi",
			APIFunc: s.HandleGetSupi,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/shared-data",
			APIFunc: s.HandleGetSharedData,
		},
		{
			Method:  http.MethodPost,
			Pattern: "/shared-data-subscriptions",
			APIFunc: s.HandleSubscribeToSharedData,
		},
	}
}
...
func (s *Server) getTwoLayerRoutes() []Route {
	return []Route{
		...
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/am-data",
			APIFunc: s.HandleGetAmData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/smf-select-data",
			APIFunc: s.HandleGetSmfSelectData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/sms-mng-data",
			APIFunc: s.HandleGetSmsMngData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/sms-data",
			APIFunc: s.HandleGetSmsData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/sm-data",
			APIFunc: s.HandleGetSmData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/nssai",
		...
		{
			Method:  http.MethodPost,
			Pattern: "/:supi/sdm-subscriptions",
			APIFunc: s.HandleSubscribe,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/trace-data",
			APIFunc: s.HandleGetTraceData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/ue-context-in-smf-data",
			APIFunc: s.HandleGetUeContextInSmfData,
		},
		{
			Method:  http.MethodGet,
			Pattern: "/:supi/ue-context-in-smsf-data",
			APIFunc: s.HandleGetUeContextInSmsfData,
		},
	}
}
