...
// Select SDPAF
// func (s *nnrfService) PCFSelection(smContext *smf_context.SMContext) error {
// 	// 直接建立 SDPAF 的 NF Profile
// 	sdpafProfile := models.NfProfile{
// 		NfInstanceId:  "sdpaf-instance-1",
// 		NfType:        models.NfType_AUSF,
// 		NfStatus:      models.NfStatus_REGISTERED,
// 		Ipv4Addresses: []string{"127.0.0.9"},
// 		NfServices: &[]models.NfService{
// 			{
// 				ServiceInstanceId: "smpolicycontrol",
// 				ServiceName:       models.ServiceName_NPCF_SMPOLICYCONTROL,
...
// 				ApiPrefix:       "http://127.0.0.9:8000",
// 			},
// 		},
// 	}

// 	smContext.SelectedPCFProfile = sdpafProfile

// 	logger.CtxLog.Infof("Selected SDPAF as PCF: %+v", sdpafProfile.NfInstanceId)
// 	return nil
// }
